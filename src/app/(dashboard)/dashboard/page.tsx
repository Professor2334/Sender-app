...
export default function DashboardOverviewPage() {
  // Mocking empty state for a new user
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 p-8 rounded-[2.5rem] bg-surface border border-outline-variant flex flex-col min-h-[400px]">
          <div className="flex justify-between items-center mb-6">
            ...
            {activeCampaigns.length > 0 && <Link href="/dashboard/campaigns" className="label-medium text-primary hover:underline">View All</Link>}
          </div>
