...
export default function DashboardOrientationPage() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-xl mx-auto">
      ...
      <h1 className="headline-large mb-4">You&apos;re All Set!</h1>
      ...
      <button 
        ...
        disabled={loading}
        className="w-full py-5 bg-primary text-on-primary rounded-2xl label-large text-xl hover:shadow-xl hover:shadow-primary/20 transition-all flex items-center justify-center gap-3 disabled:opacity-70"
      >
        {loading ? (
           <>
