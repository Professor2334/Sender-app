    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-300">
      ...
      <div className="relative bg-surface border border-outline-variant rounded-[2rem] w-full max-w-4xl max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-300 overflow-hidden">
        ...
        <div className="p-6 sm:p-8 border-t border-outline-variant bg-surface-container-lowest flex items-center justify-between">
          <button 
            onClick={onClose}
            className="px-6 py-3 rounded-xl border border-outline label-large hover:bg-surface-variant transition-colors"
          >
            Cancel
          </button>
          <button 
            ...
            className="px-8 py-3 bg-primary text-on-primary rounded-xl label-large hover:shadow-lg hover:shadow-primary/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 group"
          >
            Review & Import
